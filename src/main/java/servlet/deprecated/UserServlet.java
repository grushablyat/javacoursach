    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path == null || path.isEmpty() || "/".equals(path)) {
            ...
            if (users != null) {
                ...
                req.getRequestDispatcher("/deprecated/user/users.jsp").forward(req, resp);
            }
        } else {
            try {
                ...
                switch (userID) {
                    case "new" -> {
                        req.getRequestDispatcher("/deprecated/user/addUser.jsp").forward(req, resp);
                    }
                    default -> {
            ...
            case "new" -> {
                if (req.getParameter("add") != null && req.getParameter("cancel") == null) {
                    result = ((new UserDBService().create(new User(
                            ...
                            new LoginService().hash(req.getParameter("password")),
